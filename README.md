...
Identifying seasonal price patterns and regional price disparities
Forecasting next 6-month commodity prices using Facebook Prophet / ARIMA
Visualizing insights on an interactive Power BI dashboard
